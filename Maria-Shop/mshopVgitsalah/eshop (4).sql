...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2020 at 06:52 PM
...
(41, 'Mshop38', 'pending', 'salaheddine', 'bouanba', 'lot 161 AL MANAR YASSAMIN', '40000', 5, 9, '1', 1),
(42, 'Mshop40', '', 'salaheddine', 'bouanba', 'lot 161 AL MANAR YASSAMIN', '40000', 12, 9, '3', 0);
...
--
ALTER TABLE `orders`
  MODIFY `idOrder` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `size_product`
  MODIFY `idPS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
