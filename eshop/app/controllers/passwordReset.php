...
if(count($errorResetPassword) == 0){
    ...
    try {
        ...
        $mail->SMTPAuth   = true;                                   
        $mail->Username   = 'bouanbasalah@gmail.com';                     
        $mail->Password   = '0646274243';                               
        $mail->SMTPSecure = 'ssl';        
        $mail->Port       = 465;                                    
    
        //Recipients
        $mail->setFrom('bouanbasalah@gmail.com', 'Mariashop');
        ...
        $mail->Body    = 'Reset your password this <a href="http://localhost/mshopVgitsalah/views/newpassword.php?token='.$token.'"><b>Here!</b></a>';
